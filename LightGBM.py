...
class SpamEmailClassifierLightGBM:  # 训练
    def __init__(self, model_file='lightgbm_model.pkl', vectorizer_file='countvectorizer_lightgbm.pkl'):
    ...
    def train(self, X, y):
        ...
        # 转换为 float32 类型（LightGBM要求特征数据为 float32 或 float64）
    ...
    def predict(self, new_texts):
        ...
        # 转换为 float32 类型，确保数据类型正确
        new_texts_counts = new_texts_counts.astype('float32')
...
if __name__ == "__main__":
    ...
    classifier = SpamEmailClassifierLightGBM()
