...
class SpamEmailClassifierXGB:
    def __init__(self, model_file='xgboost_model.pkl', vectorizer_file='countvectorizer_xgboost.pkl'):
    ...
    def train(self, X, y):
        ...
        # 转换为 float32 类型（XGBoost 也可以接受这种类型）
...
if __name__ == "__main__":
    ...
    classifier = SpamEmailClassifierXGB()
